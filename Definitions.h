...
/*PUSH BUTTON*/
#define PB_close        (RX_PORTA & 0b00000001)        
#define PB_down         (RX_PORTA & 0b00000010)
#define PB_roll_ccw     (RX_PORTA & 0b00000100)
#define PB_roll_cw      (RX_PORTA & 0b00001000)
#define PB_up           (RX_PORTA & 0b00010000)
#define PB_open         (RX_PORTA & 0b00100000)

#define PB_pitch_down   (RX_PORTB & 0b00000001)
#define PB_forward      (RX_PORTB & 0b00000010)
#define PB_right        (RX_PORTB & 0b00000100)
#define PB_left         (RX_PORTB & 0b00001000)
#define PB_backward     (RX_PORTB & 0b00010000)
#define PB_pitch_up     (RX_PORTB & 0b00100000)


#define PB_close_on()       (PB_close==0)
#define PB_close_off()      (PB_close!=0)
#define PB_down_on()        (PB_down==0)
#define PB_down_off()       (PB_down!=0)
#define PB_roll_ccw_on()    (PB_roll_ccw==0)
#define PB_roll_ccw_off()   (PB_roll_ccw!=0)
#define PB_roll_cw_on()     (PB_roll_cw==0)
#define PB_roll_cw_off()    (PB_roll_cw!=0)
#define PB_up_on()          (PB_up==0)
#define PB_up_off()         (PB_up!=0)
#define PB_open_on()        (PB_open==0)
#define PB_open_off()       (PB_open!=0)
#define PB_pitch_up_on()    (PB_pitch_up==0)
#define PB_pitch_up_off()   (PB_pitch_up!=0)
#define PB_forward_on()     (PB_forward==0)
#define PB_forward_off()    (PB_forward!=0)
#define PB_right_on()       (PB_right==0)
#define PB_right_off()      (PB_right!=0)
#define PB_left_on()        (PB_left==0)
#define PB_left_off()       (PB_left!=0)
#define PB_backward_on()    (PB_backward==0)
#define PB_backward_off()   (PB_backward!=0)
#define PB_pitch_down_on()  (PB_pitch_down==0)
#define PB_pitch_down_off() (PB_pitch_down!=0)
